...
const PROMPT_HEAD =
  ...
  "- 구매 만류 (예: '사지 마세요')\n" +
  "- 욕설·비속어·화풀이는 대상을 가리지 않고 부정입니다. 제품·브랜드를 겨냥하지 않았거나 다른 댓글러를 향한 댓글 싸움·화풀이라도 부정 (예: '씨발', '꺼져', '닥쳐', '새끼'). 단 '존맛', '미쳤다 맛있어'처럼 명백한 애정·감탄만 정상.\n" +
  "- 광고 배우·모델의 연기·연출에 대한 비판·조롱 (예: '발연기', '연출 오글거려', '연기 왜 저래')\n" +
  "- 댓글러 간 다툼·시비·신고 언급 (예: '너나 잘하세요', '신고함')\n" +
  "- 제품·브랜드와 무관한 정치·시사·연예인·지인 언급이나 드립 (예: '△△ 닮았다', '우리 이모가 좋아함', 정치 얘기)\n" +
  "정상으로 판단(alert=false):\n" +
  "- 긍정·중립·감탄·질문·태그·이모지, 제품·브랜드에 대한 호감·구매의향, 이 광고의 인플루언서·모델에 대한 응원·칭찬은 정상.\n" +
  ...
  "- 위 부정 항목에 없는 순수 중립·일상 잡담(적대·욕설·인물 언급·시비가 아닌 것)은 정상.\n\n";
