...
const AWARENESS_AD_POLICY =
  ...
  "- 광고 그 자체에 대한 피로·거부·냉소는 부정 (예: '또 광고냐', '광고 지겹다', '몇번이나 보는거여', '왜 자꾸 뜨나 했더니 광고').\n" +
  "- 브랜드·캠페인을 향한 냉소·조롱, 문맥 없는 적대·거부 한두 마디도 부정 (예: '차단', '꺼져', 'ㄲㅈ', '노잼', '극혐', '슈기 홍보임 아스크림 홍보임 ㅋㅋ').\n" +
  ...
  "- 제품 효능·성분·차별성에 대한 의구심이나 경쟁품 비교절하는 부정 (예: '뭔 메로나를 제쳐', '걍 메로나랑 똑같음').\n" +
...
const PROMPT_HEAD =
  ...
  "- 경쟁 제품을 들어 **라라스윗/쫀득바를 명확히 깎아내림** (예: '이거 살 바엔 메로나 먹지', '쫀득바보다 메론바가 낫다')\n" +
