...
const OWNED_CHANNEL_POLICY =
  ...
  "- 단, 부정의 대상이 제품·브랜드·회사·마케팅·이 광고임이 드러나야 합니다. 다른 댓글러를 명시적으로 지목한 말다툼, 정치·시사·연예인 잡담, 제품·광고와 무관한 드립은 정상입니다.\n" +
  "- 광고 모델·인플루언서 개인의 외모·연기·호감만 평가하고 제품·브랜드·광고를 깎아내리지 않으면 정상입니다(예: '발연기', '○○님 잘생겼다'). 단순 '광고네' 인지나 '광고 참신하다/잘 만들었다' 같은 칭찬도 정상입니다.\n" +
