...
export function summarizeYouTubeSurvey(collected, alerts, seen, stats, estimatedUsd) {
  ...
  return {
    ...
    namedAdVideos: collected.namedAdVideos || 0,
    creatorAssignedVideos: collected.creatorAssignedVideos || 0,
...
async function writeStepSummary(summary) {
  ...
  const lines = [
    ...
    `- 소재명 확인 / 제작자 매핑 영상: ${summary.namedAdVideos} / ${summary.creatorAssignedVideos}`,
